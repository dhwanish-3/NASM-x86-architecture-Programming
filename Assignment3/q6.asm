        ...
        calculate_sumof_matrices:
            ...
            i_loop:
                ...
                j_loop:
                    ...
                    mov esi,sum_matrix
                    movzx ecx,word[k]
                    mov dx,word[eax+2*ecx]
                    add dx,word[ebx+2*ecx]
                    mov word[esi+2*ecx],dx
                    inc word[k]
                    inc word[j]
                    jmp j_loop
                end_j_loop:
...
matrix_input2:
    ...
    while_i_lessthan_m2:
        mov ax,word[m]
        cmp word[i],ax
        je end_while_i_lessthan_m2
        mov word[j],0
        while_j_lessthan_n2:
            mov ax,word[n]
            cmp word[j],ax
            je end_while_j_lessthan_n2
            call scanf
            mov cx,ax
            movzx eax,word[k]
            mov ebx,matrix2
            ...
            inc word[k]
            inc word[j]
            jmp while_j_lessthan_n2
        end_while_j_lessthan_n2:
            inc word[i]
            jmp while_i_lessthan_m2
    end_while_i_lessthan_m2:
        mov ebx,[matrix2]
        ret
